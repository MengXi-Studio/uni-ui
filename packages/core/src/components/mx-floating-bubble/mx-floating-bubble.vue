<template>
	<view v-if="modelValue" class="mx-floating-bubble" :class="customClass" :style="rootStyle">
		<movable-area class="mx-floating-bubble__area">
			<movable-view class="mx-floating-bubble__bubble" :direction="directionMap" :x="x" :y="y" :out-of-bounds="false" :damping="30" @change="onChange" @touchend="onTouchEnd" @click="onClick">
				<slot>
