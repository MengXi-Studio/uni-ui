<template>
	<view class="mx-grid-item" :class="[{ 'mx-grid-item--square': square }, customClass]" :style="itemStyle" @click="onClick">
		<view class="mx-grid-item__content" :class="{ 'mx-grid-item__content--center': center, 'mx-grid-item__content--border': border }">
