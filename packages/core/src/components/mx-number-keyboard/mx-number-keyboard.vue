<template>
	<view class="mx-number-keyboard" :class="[`mx-number-keyboard--${theme}`, customClass]" :style="keyboardStyle" @touchmove.stop.prevent>
		<!-- 自定义主题头部 -->
		...
		<view class="mx-number-keyboard__body">
			...
			<view v-for="row in digitRows" :key="row[0]" class="mx-number-keyboard__row">
				<view v-for="k in row" :key="k" class="mx-number-keyboard__key" :class="`mx-number-keyboard__key--num`" hover-class="mx-number-keyboard__key--active" @click="onInput(k)">
			...
			<view class="mx-number-keyboard__row">
				...
				<view class="mx-number-keyboard__key mx-number-keyboard__key--0" hover-class="mx-number-keyboard__key--active" @click="onInput('0')">
					<text class="mx-number-keyboard__key-text">0</text>
				</view>
				<view class="mx-number-keyboard__key mx-number-keyboard__key--delete" hover-class="mx-number-keyboard__key--active" @click="onDelete">
		...
		<view v-if="theme === 'default'" class="mx-number-keyboard__sidebar">
			<view class="mx-number-keyboard__sidebar-close" hover-class="mx-number-keyboard__key--active" @click="onClose">
