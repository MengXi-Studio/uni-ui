	...
	<mx-popup
		...
		<view class="mx-dialog">
			...
			<view v-if="showConfirmButton || showCancelButton" class="mx-dialog__footer">
				<view v-if="showCancelButton" class="mx-dialog__button" hover-class="mx-dialog__button--active" @click="onCancel">
					<text class="mx-dialog__button-text">{{ cancelButtonText }}</text>
				</view>
				<view v-if="showConfirmButton" class="mx-dialog__button" hover-class="mx-dialog__button--active" @click="onConfirm">
					<text class="mx-dialog__button-text mx-dialog__button-text--confirm" :style="confirmTextStyle">
						{{ confirmButtonText }}
					</text>
				</view>
			</view>
