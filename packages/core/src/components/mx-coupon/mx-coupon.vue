<template>
	<view class="mx-coupon" :class="[{ 'mx-coupon--chosen': chosen, 'mx-coupon--disabled': disabled }, customClass]" :style="customStyle" :hover-class="'mx-coupon--hover'" @click="onClick">
