  ...
  <view class="mx-uploader" :class="customClass" :style="customStyle">
    <view class="mx-uploader__wrap">
      ...
      <view
        ...
        :key="index"
        class="mx-uploader__preview"
        :class="{ 'mx-uploader__preview--disabled': disabled }"
        @click="onPreview(file, index)"
      >
        <mx-image
          v-if="isImage(file)"
          class="mx-uploader__image"
          :src="fileUrl(file)"
          :width="previewSize"
          :height="previewSize"
        />
      ...
      <view
        ...
        class="mx-uploader__upload"
        :class="{ 'mx-uploader__upload--readonly': readonly }"
        @click="onChoose"
      >
