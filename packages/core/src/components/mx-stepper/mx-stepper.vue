<template>
  ...
  >
    <view
      class="mx-stepper__minus"
      :class="{ 'mx-stepper__minus--disabled': minusDisabled }"
      @click="onMinus"
      @touchstart="onMinusStart"
      @touchend="onPressEnd"
    ...
    <view
      class="mx-stepper__plus"
      :class="{ 'mx-stepper__plus--disabled': plusDisabled }"
      @click="onPlus"
      @touchstart="onPlusStart"
      @touchend="onPressEnd"
      @touchcancel="onPressEnd"
    >
