<template>
	<view class="mx-submit-bar" :class="[{ 'mx-submit-bar--safe-bottom': safeAreaInsetBottom }, customClass]" :style="customStyle">
		<slot name="top" />
...
const amount = computed(() => {
	...
	const fixed = Number.isFinite(num) ? num.toFixed(Number(props.decimalLength) || 0) : (0).toFixed(Number(props.decimalLength) || 0)
	return fixed
})
