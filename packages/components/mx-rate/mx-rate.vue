<template>
  <view
    class="mx-rate"
    :class="[{ 'mx-rate--disabled': disabled, 'mx-rate--readonly': readonly }, customClass]"
    :style="customStyle"
...
const itemStyle = computed(() =>
  props.gutter ? ({ marginRight: props.gutter } as Record<string, string>) : {}
)
