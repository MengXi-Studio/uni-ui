...
export const META_TITLE = 'MengXi Uni-UI'
export const META_DESCRIPTION =
  'A high-quality uni-app component library built with Vue 3 + TypeScript'

/** 英文组件侧边栏：6 大分类（对应 src/en/components/ 下的英文镜像） */
const enComponentSidebar: DefaultTheme.SidebarItem[] = [
  {
...
const enSidebar: DefaultTheme.SidebarMulti = {
  '/en/guide/': [enGuide, ...enComponentSidebar],
  '/en/components/': enComponentSidebar,
}
...
export const enConfig: LocaleSpecificConfig<DefaultTheme.Config> = {
  ...
  themeConfig: {
    /** 网站主题配置 编辑链接 */
    editLink: {
      pattern: 'https://github.com/MengXi-Studio/mengxi-uni-ui/edit/main/packages/docs/:path',
    ...
    nav: [
      ...
      { text: 'Components', link: '/en/components/basic/button' },
      {
        text: 'Links',
        items: [
          { text: 'Issues', link: 'https://github.com/MengXi-Studio/mengxi-uni-ui/issues' },
          { text: 'Changelog', link: 'https://github.com/MengXi-Studio/mengxi-uni-ui/releases' },
        ],
      },
      versionNav,
    ],
