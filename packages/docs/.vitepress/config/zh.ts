...
/** 中文组件侧边栏：6 大分类 */
const zhComponentSidebar: DefaultTheme.SidebarItem[] = [
  {
    text: '基础组件',
    items: [
...
const zhGuide: DefaultTheme.SidebarItem = {
  text: '指南',
  items: [
...
const zhSidebar: DefaultTheme.SidebarMulti = {
  '/guide/': [zhGuide, ...zhComponentSidebar],
  '/components/': zhComponentSidebar,
}
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '组件', link: '/components/basic/button' },
      {
        text: '相关链接',
        items: [
          { text: '意见反馈', link: 'https://github.com/MengXi-Studio/mengxi-uni-ui/issues' },
          { text: '更新日志', link: 'https://github.com/MengXi-Studio/mengxi-uni-ui/releases' },
        ],
      },
      versionNav,
    ],
