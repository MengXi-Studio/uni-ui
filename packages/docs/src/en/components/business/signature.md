...
```vue
<mx-signature v-model="signature" color="#1989fa" :pen-size="5" bg-color="#f7f8fa" :height="240" tip-text="Please sign here" close-button-text="Redo" confirm-button-text="Done" @submit="onSubmit" />
```
